...
import {
  ...
  type InterestId,
  type RequiredField,
} from "@/lib/concept-v2/demo-request";
 ...
 * it does with them is one awaited call — see lib/concept-v2/demo-request.ts,
...
export function RequestDemo() {
  ...
  const toggleInterest = (id: InterestId) => {
    ...
    setValues((v) => {
      ...
      track("demo_request_interest_selected", { interest: id, selected: !on, count: interests.length });
      return { ...v, interests };
    });
  };
  ...
  const toggleAll = () => {
    ...
    setValues((v) => {
      ...
      track("demo_request_interest_selected", { interest: "all", selected: !allSelected, count: interests.length });
      return { ...v, interests };
    });
  };
      ...
      <div className={styles.successWrap}>
        <div className={`shell ${styles.success}`} ref={successRef} tabIndex={-1}>
          ...
          <div className={styles.successActions}>
            ...
            <Button href="/concept-v2/pricing" tone="secondary" size="lg">
              View pricing
            </Button>
          </div>
        </div>
          ...
          <form className={styles.form} onSubmit={onSubmit} noValidate>
            ...
            <div className={styles.fields}>
              {FIELDS.map((field) => {
                ...
                return (
                  <p key={field.name} className={styles.field} data-invalid={bad ? true : undefined}>
            ...
            <fieldset className={styles.interests}>
              ...
              <div className={styles.chips}>
                ...
                <label className={`${styles.chip} ${styles.chipAll}`} data-on={allSelected || undefined}>
                  <input
                    type="checkbox"
                    className={styles.chipInput}
                    checked={allSelected}
