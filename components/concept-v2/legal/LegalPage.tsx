        ...
        <header className={styles.head}>
          ...
          {!readiness.ready && (
            <p className={styles.pending}>
              ...
              <code>[{PLACEHOLDER_PREFIX}: …]</code> are values — company entity,
              registered address, contact addresses, governing law and effective date —
              that will be supplied before this page is published.
            </p>
          )}
        </header>
        ...
        <div className={styles.body}>
          ...
          <div className={styles.sections}>
            ...
            <div className={styles.foot}>
              ...
              <Link href="/concept-v2">Back to Malaky</Link>
            </div>
          </div>
        </div>
      </div>
